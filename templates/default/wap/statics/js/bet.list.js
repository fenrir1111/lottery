    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (var i = 0;data.data!=null && data.data.Records!=null && i < data.data.Records.length; i++) {
                ...
                var subName = data.data.Records[i].SubName;
                var subType = data.data.Records[i].SubId;

                if (',10,11,16,17,'.indexOf(','+data.data.Records[i].GameId+',') > -1 && subName == '和值') {
                    subType = '和值';
                } else if (data.data.Records[i].GameId == 18) {//六合彩
                ...
                if (data.data.Records[i].GameId == 41 || data.data.Records[i].GameId == 42){
...
//                tmpPrize = (data.data.Records[i].BetPrize != 0) ? tmpPrize+'|'+data.data.Records[i].BetPrize : tmpPrize;
                var detail = 'oid='+data.data.Records[i].Id+'&money='+data.data.Records[i].Amount
                    ...
                    +'&code='+betCode+'&subid='+data.data.Records[i].PlayId
                    +'&gname='+data.data.Records[i].GameId+'&winamount='+data.data.Records[i].WinAmount
                ...
                if (data.data.Records[i].Status == 2) {
                    tmpStatus = '已取消';
                } else if (data.data.Records[i].Etime !="") {//已结算
                ...
                txtHtml += '<li>'
                    ...
                    + '<span class="fr c-red">-'+data.data.Records[i].BetMoney+'元</span><span class="order-top-left">'+data.data.Records[i].GameId+'</span>第'+data.data.Records[i].GamePeriod+'期'
                    + '</div>'
